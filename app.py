...
logger.add(LOG_PATH / "app.log", rotation="100 MB", retention="7 days")
...
class LocalLLMClient:
    """Runs microsoft/Phi-3-mini-4k-instruct locally on GPU."""
    ...
    def __init__(self, config: ContinuumConfig):
        ...
        # Use cache directory in data folder
        cache_dir = str(BASE_PATH / "models")
        ...
        # Load in float16 (stable without bitsandbytes)
...
def main():
    ...
    # Parse command line args for deployment
    import argparse
